...
public class ArP2Arm {
  ...
  public State init() {
    return State.swigToEnum(AriaJavaJNI.ArP2Arm_init(swigCPtr, this));
  }

  public State uninit() {
    return State.swigToEnum(AriaJavaJNI.ArP2Arm_uninit(swigCPtr, this));
  }

  public State powerOn(boolean doWait) {
    return State.swigToEnum(AriaJavaJNI.ArP2Arm_powerOn__SWIG_0(swigCPtr, this, doWait));
  }

  public State powerOn() {
    return State.swigToEnum(AriaJavaJNI.ArP2Arm_powerOn__SWIG_1(swigCPtr, this));
  }

  public State powerOff() {
    return State.swigToEnum(AriaJavaJNI.ArP2Arm_powerOff(swigCPtr, this));
  }

  public State requestInfo() {
    return State.swigToEnum(AriaJavaJNI.ArP2Arm_requestInfo(swigCPtr, this));
  }

  public State requestStatus(StatusType status) {
    return State.swigToEnum(AriaJavaJNI.ArP2Arm_requestStatus(swigCPtr, this, status.swigValue()));
  }

  public State requestInit() {
    return State.swigToEnum(AriaJavaJNI.ArP2Arm_requestInit(swigCPtr, this));
  }

  public State checkArm(boolean waitForResponse) {
    return State.swigToEnum(AriaJavaJNI.ArP2Arm_checkArm__SWIG_0(swigCPtr, this, waitForResponse));
  }

  public State checkArm() {
    return State.swigToEnum(AriaJavaJNI.ArP2Arm_checkArm__SWIG_1(swigCPtr, this));
  }

  public State home(int joint) {
    return State.swigToEnum(AriaJavaJNI.ArP2Arm_home__SWIG_0(swigCPtr, this, joint));
  }

  public State home() {
    return State.swigToEnum(AriaJavaJNI.ArP2Arm_home__SWIG_1(swigCPtr, this));
  }

  public State park() {
    return State.swigToEnum(AriaJavaJNI.ArP2Arm_park(swigCPtr, this));
  }

  public State moveTo(int joint, float pos, short vel) {
    return State.swigToEnum(AriaJavaJNI.ArP2Arm_moveTo__SWIG_0(swigCPtr, this, joint, pos, vel));
  }

  public State moveTo(int joint, float pos) {
    return State.swigToEnum(AriaJavaJNI.ArP2Arm_moveTo__SWIG_1(swigCPtr, this, joint, pos));
  }

  public State moveToTicks(int joint, short pos) {
    return State.swigToEnum(AriaJavaJNI.ArP2Arm_moveToTicks(swigCPtr, this, joint, pos));
  }

  public State moveStep(int joint, float pos, short vel) {
    return State.swigToEnum(AriaJavaJNI.ArP2Arm_moveStep__SWIG_0(swigCPtr, this, joint, pos, vel));
  }

  public State moveStep(int joint, float pos) {
    return State.swigToEnum(AriaJavaJNI.ArP2Arm_moveStep__SWIG_1(swigCPtr, this, joint, pos));
  }

  public State moveStepTicks(int joint, byte pos) {
    return State.swigToEnum(AriaJavaJNI.ArP2Arm_moveStepTicks(swigCPtr, this, joint, pos));
  }

  public State moveVel(int joint, int vel) {
    return State.swigToEnum(AriaJavaJNI.ArP2Arm_moveVel(swigCPtr, this, joint, vel));
  }

  public State stop() {
    return State.swigToEnum(AriaJavaJNI.ArP2Arm_stop(swigCPtr, this));
  }

  public State setAutoParkTimer(int waitSecs) {
    return State.swigToEnum(AriaJavaJNI.ArP2Arm_setAutoParkTimer(swigCPtr, this, waitSecs));
  }

  public State setGripperParkTimer(int waitSecs) {
    return State.swigToEnum(AriaJavaJNI.ArP2Arm_setGripperParkTimer(swigCPtr, this, waitSecs));
  }
