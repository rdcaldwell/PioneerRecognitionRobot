...
public class ArVCC4 extends ArPTZ {
  ...
  public ArVCC4(long cPtr, boolean cMemoryOwn) {
    super(AriaJavaJNI.ArVCC4_SWIGUpcast(cPtr), cMemoryOwn);
    swigCPtr = cPtr;
  }
  ...
  public ArVCC4(ArRobot robot, boolean inverted, CommState commDirection, boolean autoUpdate, boolean disableLED, CameraType cameraType) {
  ...
  public ArVCC4(ArRobot robot, boolean inverted, CommState commDirection, boolean autoUpdate, boolean disableLED) {
  ...
  public ArVCC4(ArRobot robot, boolean inverted, CommState commDirection, boolean autoUpdate) {
    this(AriaJavaJNI.new_ArVCC4__SWIG_2(ArRobot.getCPtr(robot), robot, inverted, commDirection.swigValue(), autoUpdate), true);
  }

  public ArVCC4(ArRobot robot, boolean inverted, CommState commDirection) {
