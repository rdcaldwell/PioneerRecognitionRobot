...
public class ArLog {
  ...
  public static boolean init(LogType type, LogLevel level, String fileName, boolean logTime, boolean alsoPrint, boolean printThisCall) {
    return AriaJavaJNI.ArLog_init__SWIG_0(type.swigValue(), level.swigValue(), fileName, logTime, alsoPrint, printThisCall);
  }

  public static boolean init(LogType type, LogLevel level, String fileName, boolean logTime, boolean alsoPrint) {
    return AriaJavaJNI.ArLog_init__SWIG_1(type.swigValue(), level.swigValue(), fileName, logTime, alsoPrint);
  }

  public static boolean init(LogType type, LogLevel level, String fileName, boolean logTime) {
    return AriaJavaJNI.ArLog_init__SWIG_2(type.swigValue(), level.swigValue(), fileName, logTime);
  }

  public static boolean init(LogType type, LogLevel level, String fileName) {
    return AriaJavaJNI.ArLog_init__SWIG_3(type.swigValue(), level.swigValue(), fileName);
  }

  public static boolean init(LogType type, LogLevel level) {
  ...
  public static void logErrorFromOS(LogLevel level, String str) {
    AriaJavaJNI.ArLog_logErrorFromOS(level.swigValue(), str);
  }

  public static void logErrorFromOSPlain(LogLevel level, String str) {
    AriaJavaJNI.ArLog_logErrorFromOSPlain(level.swigValue(), str);
  }

  public static void logBacktrace(LogLevel level) {
    AriaJavaJNI.ArLog_logBacktrace(level.swigValue());
  }

  public static boolean logFileContents(LogLevel level, String fileName) {
  ...
  public static void aramInit(String prefix, LogLevel defaultLevel, double defaultSize, boolean daemonized) {
    AriaJavaJNI.ArLog_aramInit__SWIG_0(prefix, defaultLevel.swigValue(), defaultSize, daemonized);
  }

  public static void aramInit(String prefix, LogLevel defaultLevel, double defaultSize) {
    AriaJavaJNI.ArLog_aramInit__SWIG_1(prefix, defaultLevel.swigValue(), defaultSize);
  }

  public static void aramInit(String prefix, LogLevel defaultLevel) {
