...
public class ArMapInfoInterface {
  ...
  public static void setMACRO_INFO_NAME(String value) {
    AriaJavaJNI.ArMapInfoInterface_MACRO_INFO_NAME_set(value);
  }

  public static String getMACRO_INFO_NAME() {
    return AriaJavaJNI.ArMapInfoInterface_MACRO_INFO_NAME_get();
  }
  ...
  public final static class InfoType {
    ...
    public final static InfoType MACRO_INFO = new InfoType("MACRO_INFO");
    ...
    private static InfoType[] swigValues = { MAP_INFO, FIRST_INFO, MACRO_INFO, META_INFO, TASK_INFO, ROUTE_INFO, SCHED_TASK_INFO, SCHED_INFO, CAIRN_INFO, CUSTOM_INFO, LAST_INFO };
