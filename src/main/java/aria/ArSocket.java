...
public class ArSocket {
  ...
  public ArSocket(String host, int port, Type type) {
    this(AriaJavaJNI.new_ArSocket__SWIG_1(host, port, type.swigValue()), true);
  }

  public ArSocket(int port, boolean doClose, Type type) {
  ...
  public boolean connect(String host, int port, Type type, String openOnIP) {
    return AriaJavaJNI.ArSocket_connect__SWIG_0(swigCPtr, this, host, port, type.swigValue(), openOnIP);
  }

  public boolean connect(String host, int port, Type type) {
  ...
  public boolean open(int port, Type type, String openOnIP) {
    return AriaJavaJNI.ArSocket_open__SWIG_0(swigCPtr, this, port, type.swigValue(), openOnIP);
  }

  public boolean open(int port, Type type) {
  ...
  public Type getType() {
    return Type.swigToEnum(AriaJavaJNI.ArSocket_getType(swigCPtr, this));
  }
  ...
  public Error getError() {
    return Error.swigToEnum(AriaJavaJNI.ArSocket_getError(swigCPtr, this));
  }
