...
public class ArMapInterface extends ArHasFileName {
  private transient long swigCPtr;

  public ArMapInterface(long cPtr, boolean cMemoryOwn) {
    super(AriaJavaJNI.ArMapInterface_SWIGUpcast(cPtr), cMemoryOwn);
    swigCPtr = cPtr;
  }
  ...
  public static void setMAP_CATEGORY_2D_TEMPLATE(String value) {
    AriaJavaJNI.ArMapInterface_MAP_CATEGORY_2D_TEMPLATE_set(value);
  }

  public static String getMAP_CATEGORY_2D_TEMPLATE() {
    return AriaJavaJNI.ArMapInterface_MAP_CATEGORY_2D_TEMPLATE_get();
  }

  public static SWIGTYPE_p_std__listT_std__string_t getMapCategoryList() {
    return new SWIGTYPE_p_std__listT_std__string_t(AriaJavaJNI.ArMapInterface_getMapCategoryList(), true);
  }
  ...
  public void mapChanged() {
    AriaJavaJNI.ArMapInterface_mapChanged__SWIG_0(swigCPtr, this);
  }

  public void mapChanged(boolean invokePathPlanningCB, boolean invokeLocalizationCB) {
    AriaJavaJNI.ArMapInterface_mapChanged__SWIG_1(swigCPtr, this, invokePathPlanningCB, invokeLocalizationCB);
  }
  ...
  public void addMapChangedPathPlanningCB(ArFunctor functor, int position) {
    AriaJavaJNI.ArMapInterface_addMapChangedPathPlanningCB__SWIG_0(swigCPtr, this, ArFunctor.getCPtr(functor), functor, position);
  }

  public void addMapChangedPathPlanningCB(ArFunctor functor) {
    AriaJavaJNI.ArMapInterface_addMapChangedPathPlanningCB__SWIG_1(swigCPtr, this, ArFunctor.getCPtr(functor), functor);
  }

  public void remMapChangedPathPlanningCB(ArFunctor functor) {
    AriaJavaJNI.ArMapInterface_remMapChangedPathPlanningCB(swigCPtr, this, ArFunctor.getCPtr(functor), functor);
  }

  public void addMapChangedLocalizationCB(ArFunctor functor, int position) {
    AriaJavaJNI.ArMapInterface_addMapChangedLocalizationCB__SWIG_0(swigCPtr, this, ArFunctor.getCPtr(functor), functor, position);
  }

  public void addMapChangedLocalizationCB(ArFunctor functor) {
    AriaJavaJNI.ArMapInterface_addMapChangedLocalizationCB__SWIG_1(swigCPtr, this, ArFunctor.getCPtr(functor), functor);
  }

  public void remMapChangedLocalizationCB(ArFunctor functor) {
    AriaJavaJNI.ArMapInterface_remMapChangedLocalizationCB(swigCPtr, this, ArFunctor.getCPtr(functor), functor);
  }
  ...
  public void addPreParseFileCB(SWIGTYPE_p_ArFunctor1T_std__string_t functor) {
    AriaJavaJNI.ArMapInterface_addPreParseFileCB(swigCPtr, this, SWIGTYPE_p_ArFunctor1T_std__string_t.getCPtr(functor));
  }

  public void remPreParseFileCB(SWIGTYPE_p_ArFunctor1T_std__string_t functor) {
    AriaJavaJNI.ArMapInterface_remPreParseFileCB(swigCPtr, this, SWIGTYPE_p_ArFunctor1T_std__string_t.getCPtr(functor));
  }
  ...
  public boolean getMapId(SWIGTYPE_p_ArMapId mapIdOut, boolean isInternalCall) {
    return AriaJavaJNI.ArMapInterface_getMapId__SWIG_0(swigCPtr, this, SWIGTYPE_p_ArMapId.getCPtr(mapIdOut), isInternalCall);
  }

  public boolean getMapId(SWIGTYPE_p_ArMapId mapIdOut) {
    return AriaJavaJNI.ArMapInterface_getMapId__SWIG_1(swigCPtr, this, SWIGTYPE_p_ArMapId.getCPtr(mapIdOut));
  }
  ...
  public String getMapCategory() {
    return AriaJavaJNI.ArMapInterface_getMapCategory(swigCPtr, this);
  }
