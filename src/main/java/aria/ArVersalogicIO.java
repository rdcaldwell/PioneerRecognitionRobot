...
public class ArVersalogicIO {
  ...
  public Direction getDigitalBankDirection(int bank) {
    return Direction.swigToEnum(AriaJavaJNI.ArVersalogicIO_getDigitalBankDirection(swigCPtr, this, bank));
  }

  public boolean setDigitalBankDirection(int bank, Direction dir) {
