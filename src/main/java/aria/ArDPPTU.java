...
public class ArDPPTU extends ArPTZ {
  ...
  public ArDPPTU(long cPtr, boolean cMemoryOwn) {
    super(AriaJavaJNI.ArDPPTU_SWIGUpcast(cPtr), cMemoryOwn);
    swigCPtr = cPtr;
  }
  ...
  public ArDPPTU(ArRobot robot, DeviceType deviceType, int deviceIndex) {
    this(AriaJavaJNI.new_ArDPPTU__SWIG_0(ArRobot.getCPtr(robot), robot, deviceType.swigValue(), deviceIndex), true);
  }

  public ArDPPTU(ArRobot robot, DeviceType deviceType) {
  ...
  public boolean setMovePower(Axis axis, PowerMode mode) {
    return AriaJavaJNI.ArDPPTU_setMovePower(swigCPtr, this, axis.swigValue(), mode.swigValue());
  }

  public boolean setHoldPower(Axis axis, PowerMode mode) {
