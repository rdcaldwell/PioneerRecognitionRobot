...
public class ArBasePacket {
  ...
  public String bufToString() {
    return AriaJavaJNI.ArBasePacket_bufToString__SWIG_0(swigCPtr, this);
  }

  public void bufToString(SWIGTYPE_p_std__string s) {
    AriaJavaJNI.ArBasePacket_bufToString__SWIG_1(swigCPtr, this, SWIGTYPE_p_std__string.getCPtr(s));
  }
  ...
  public boolean bufferContainsBytes(int bytes) {
    return AriaJavaJNI.ArBasePacket_bufferContainsBytes(swigCPtr, this, bytes);
  }
