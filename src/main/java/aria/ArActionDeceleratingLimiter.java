...
public class ArActionDeceleratingLimiter extends ArAction {
  ...
  public ArActionDeceleratingLimiter(long cPtr, boolean cMemoryOwn) {
    super(AriaJavaJNI.ArActionDeceleratingLimiter_SWIGUpcast(cPtr), cMemoryOwn);
    swigCPtr = cPtr;
  }
  ...
  public ArActionDeceleratingLimiter(String name, LimiterType type) {
  ...
  public LimiterType getType() {
    return LimiterType.swigToEnum(AriaJavaJNI.ArActionDeceleratingLimiter_getType(swigCPtr, this));
  }

  public void setType(LimiterType type) {
