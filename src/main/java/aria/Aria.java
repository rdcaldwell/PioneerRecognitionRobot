...
public class Aria {
  ...
  public static void init(SigHandleMethod method, boolean initSockets, boolean sigHandleExitNotShutdown) {
    AriaJavaJNI.Aria_init__SWIG_0(method.swigValue(), initSockets, sigHandleExitNotShutdown);
  }

  public static void init(SigHandleMethod method, boolean initSockets) {
    AriaJavaJNI.Aria_init__SWIG_1(method.swigValue(), initSockets);
  }

  public static void init(SigHandleMethod method) {
